...
<CardGroup cols={2}>
  ...
  <Card title="Create Protocols" icon="cog">
    Define how patients enroll in healthcare programs
  </Card>
...
4. **Create protocols** - Define enrollment workflows (standard or custom)
5. **Enroll in protocols** - Get patients signed up for care through protocols

**Protocol-First Architecture:** All enrollments go through Protocols. When a patient enrolls in a protocol, the system automatically creates the necessary program enrollments behind the scenes.
